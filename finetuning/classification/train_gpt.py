...
class IMDbDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        label = self.data.row(index)[1]  # Assuming columns: text (0), label (1)
...
if __name__ == "__main__":
    ...
    if args.context_length == "model_context_length":
        ...
        temp_dataset = IMDbDataset(train_df, tokenizer, max_length=None)
    ...
    train_split = train_df[:train_size]
    val_split = train_df[train_size:]

    if train_dataset is None:
        train_dataset = IMDbDataset(train_split, tokenizer, max_length)
    val_dataset = IMDbDataset(val_split, tokenizer, max_length)
